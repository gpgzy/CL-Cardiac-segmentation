...
class BaseDataSet(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # print(label)
        # plt.subplot(121), plt.imshow(image[0], cmap="gray"), plt.title('res')
        # plt.subplot(122), plt.imshow(label, cmap='gray'), plt.title('src')
        # plt.show()
        # plt.subplot(121),plt.imshow(image[0].reshape(320,320,1),cmap="gray")
        # plt.subplot(122),plt.imshow(label.reshape(320,320,1),cmap="gray")
        # plt.show()
